...
string_5d_ago = (today - relativedelta(days=10)).strftime('%Y-%m-%d')
# end_date = '2022-4-17'
...
# make script for short term only
...
day = -1 # minus 1 means most recent candle
freq = 'min'
rise_drop_days = 5
...
for i, ticker in enumerate(stock_list_snp): # i is mainly for printing only
...
with open('interested_tickers_dr1x.html', 'a') as f:
